use crate::{
    ...
    V7_SPELL_VK, V8, V8_SPELL_VK, V9, V9_SPELL_VK, ark, bitcoin_tx::BitcoinTx,
...
pub const CURRENT_GROTH16_VK_BYTES: &'static [u8] = V10_GROTH16_VK_BYTES;

pub fn to_serialized_pv<T: Serialize>(spell_version: u32, t: &T) -> Vec<u8> {
    match spell_version {
        CURRENT_VERSION | V9 | V8 | V7 | V6 | V5 | V4 | V3 | V2 | V1 => {
